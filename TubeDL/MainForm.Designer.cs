...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        textBoxInput.TextChanged += SearchInput_TextChanged;
        // 
        // buttonSearch
        // 
        ...
        labelPlaceholder.Click += SearchPlaceholder_Click;
        // 
        // labelError
        // 
        ...
        buttonPause.Font = new Font("Trebuchet MS", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
        buttonPause.Location = new Point(742, 662);
        buttonPause.Name = "buttonPause";
        buttonPause.Size = new Size(58, 40);
        buttonPause.TabIndex = 17;
        buttonPause.Text = "||";
        buttonPause.UseVisualStyleBackColor = true;
        buttonPause.Click += PauseDownload;
        // 
        // buttonCancel
        // 
        buttonCancel.BackColor = Color.Tomato;
        buttonCancel.Cursor = Cursors.Hand;
        buttonCancel.Font = new Font("Trebuchet MS", 10.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
        buttonCancel.Location = new Point(799, 662);
        buttonCancel.Name = "buttonCancel";
        buttonCancel.Size = new Size(58, 40);
        buttonCancel.TabIndex = 23;
        buttonCancel.Text = "✕";
        buttonCancel.UseVisualStyleBackColor = false;
        buttonCancel.Click += CancelDownload;
        // 
        // MainForm
        // 
